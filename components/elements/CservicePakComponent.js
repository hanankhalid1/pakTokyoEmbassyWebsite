...
const dataEng = {
  ...
  mainTitle: "Consular Services For Pakistanis",
  paragraph: "Information Related To Consular Services For Pakistanis",
...
const dataJpn = {
  subTitle: "領事サービス",
  mainTitle: "パキスタン人向け領事サービス",
  paragraph: "パキスタン人向け領事サービスに関する情報",
  furtherInfoTitle: "詳細情報については",
  furtherInfoLink: "ここをクリック",
};

const CservicePakComponent = () => {
      ...
      <section className="handpicked-post-area section__hover-line pt-75 pb-50">
        <div className="container">
          ...
          <div>
            ...
            <Link href="https://www.pakistanembassytokyo.com/content/consular-services-pakistanis" target="_blank">
...
export default CservicePakComponent;
